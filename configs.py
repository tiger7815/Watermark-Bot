...
class Config(object):
    ...
    **Usage:** First Send a JPG Image/Logo, then send any Video. It's better to add a watermark to an MP4 or MKV Video.
    ...
    ETA 🕰: {4}
    """
    DELETE_AFTER_TRANSFER = bool(os.environ.get("DELETE_AFTER_TRANSFER", False))
